...
Chapters 2 - 8 exercises were frequently short or involved code that built on a previous exercise. Many of those were combined into a single program with functions named for each exercise. The appropriate exercise code can be executed a simple modification to main() to call the desired function. Ex: Exercise10();  // run Exercise 10 code
